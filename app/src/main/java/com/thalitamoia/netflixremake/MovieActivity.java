package com.thalitamoia.netflixremake;
...
import com.thalitamoia.netflixremake.model.Movie;
import com.thalitamoia.netflixremake.model.MovieDetail;
import com.thalitamoia.netflixremake.util.ImageDawnloaderTask;
import com.thalitamoia.netflixremake.util.MovieDetailTask;
...
public class MovieActivity extends AppCompatActivity implements MovieDetailTask.MovieDetailLoader {
    ...
    public void onResult(MovieDetail movieDetail) {
        ...
        ImageDawnloaderTask imageDownloaderTask = new ImageDawnloaderTask(imgCover);
    ...
    private class MovieAdapter extends RecyclerView.Adapter<MovieHolder> {
        ...
        public void onBindViewHolder(@NonNull MovieHolder holder, int position) {
            ...
            new ImageDawnloaderTask(holder.imageViewCover).execute(movie.getCoverUrl());
        }
